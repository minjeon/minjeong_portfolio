...
### 🔹 SKN 1차 단위 프로젝트
- 기간: 2025/07/04-2025/07/11
- 프로젝트 주제 : 전기차 구매 서포터 & 기업 FAQ 
...
### 🔹 SKN 3차 단위 프로젝트
- 기간 : 2025/09/17-2025/09/25
- 프로젝트 주제 : 초보 운전자들을 위한 운전 어시스턴트
- 역할 : 데이터 수집 및 정제, streamlit 구현, 리드미 작성, Vector DB 연동, RAG pipeline 구축 
- 링크 : https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN17-3rd-5Team
...
ogo=Google%20Drive&logoColor=white) |
